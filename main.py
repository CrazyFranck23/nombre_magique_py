...
def demander_nombre(nb_min, nb_max):
    ...
    while nombre_int == 0:
        ...
        try:
            ...
            print("ERREUR: Vous devez absolument rentrer un nombre. Réessayez.")
        else:
...
# Utilisation d'une boucle for pour limiter le nombre de vies (plus haut boucle while utilisé)
"""
gagne = False
